...
public class ProcessStudentInfo {
	...
	public static void main(String[] args) throws ParserConfigurationException, SAXException, IOException {
		...
		for(Student st:list){
			System.out.println(st.id+" "+st.firstName+" "+st.lastName + " " + scoreToGrade(st.score));
		}
	}
	
	// convert score to grade
	public static String scoreToGrade(String score) {
		String retGrade = "Grade= ";
		int numScore = Integer.parseInt(score);
		int grade = numScore / 10; 
		switch(grade) {
			case 10: retGrade += "A"; break;
			case 9:  retGrade += "A"; break;
			case 8:  retGrade += "B"; break;
			case 7:  retGrade += "C"; break;
			default: retGrade += "D"; break;
		}
		return retGrade;
	}
